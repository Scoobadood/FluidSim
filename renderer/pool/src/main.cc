 ...
 * ******************************************************************************************/
void generate_geometry(uint32_t num_columns, float width, float depth, const std::vector<float> &heights,
                       std::vector<float>& vertex_data,
                       std::vector<uint32_t>& indices) {
  auto total_width = (float)num_columns * width;
...
void create_geometry(GLuint &vao, GLuint &vbo, GLuint &ebo, GLsizei &num_elements) {
  ...
  generate_geometry(5, 0.25f, 0.25f, {1.0f, 0.8f, 0.6f, 0.7f, 0.3f}, vertex_data, index_data);
...
//  model = glm::translate(model,glm::vec3(0,0,-10));
    ...
    shader->set_uniform("light_dir", glm::vec3(10, -10, 0));
    ...
    shader->set_uniform("object_colour", glm::vec3{1.0f, 0.6f, 0.0f});
